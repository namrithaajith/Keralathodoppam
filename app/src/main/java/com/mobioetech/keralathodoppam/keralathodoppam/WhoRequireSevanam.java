...
public class WhoRequireSevanam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_who_require_sevanam);
        ...
        WhoRequireSevanamAdapter adapter = new WhoRequireSevanamAdapter(this, sevanamTypes);
