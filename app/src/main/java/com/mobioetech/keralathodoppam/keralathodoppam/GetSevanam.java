...
public class GetSevanam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_sevanam);
        ...
        GetSevanamAdapter adapter = new GetSevanamAdapter(this, sevanamTypes);
