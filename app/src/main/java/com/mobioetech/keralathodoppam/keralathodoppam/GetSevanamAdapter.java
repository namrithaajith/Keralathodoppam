...
public class GetSevanamAdapter extends RecyclerView.Adapter<GetSevanamAdapter.ViewHolder> {

    private ArrayList<SevanamTypes> sevanamTypes;
    private Context context;
    private static final String LOG = "sevanamAdapter";

    public GetSevanamAdapter(Context context, ArrayList<SevanamTypes> sevanamTypes) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                intent = new Intent(context,ViewSevanam.class);
                switch(position){
