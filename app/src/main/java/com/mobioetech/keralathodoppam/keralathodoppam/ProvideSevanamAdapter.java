...
public class ProvideSevanamAdapter extends RecyclerView.Adapter<ProvideSevanamAdapter.ViewHolder> {
    ...
    public ProvideSevanamAdapter(Context context, ArrayList<SevanamTypes> sevanamTypes) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                intent = new Intent(context,SevanamRegistration.class);
                switch(position){
