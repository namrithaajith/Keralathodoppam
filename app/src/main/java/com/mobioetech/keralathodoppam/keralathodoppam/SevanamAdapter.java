...
public class SevanamAdapter extends RecyclerView.Adapter<SevanamAdapter.ViewHolder> {

    private ArrayList<SevanamTypes> sevanamTypes;
    private Context context;
    private static final String LOG = "sevanamAdapter";

    public SevanamAdapter(Context context, ArrayList<SevanamTypes> sevanamTypes) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.img_category.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                switch(position){
                    case 0:intent = new Intent(context,ProvideSevanam.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(intent);
                            break;
                    case 1:intent = new Intent(context,GetSevanam.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(intent);
                        break;
                    case 2:intent = new Intent(context,AskForSevanam.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(intent);
                        break;
                    case 3:intent = new Intent(context,WhoRequireSevanam.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(intent);
                        break;
