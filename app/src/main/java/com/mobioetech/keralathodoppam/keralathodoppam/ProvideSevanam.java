...
public class ProvideSevanam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_provide_sevanam);
        ...
        ProvideSevanamAdapter adapter = new ProvideSevanamAdapter(this, sevanamTypes);
