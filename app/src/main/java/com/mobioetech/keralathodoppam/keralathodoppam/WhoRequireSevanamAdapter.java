...
public class WhoRequireSevanamAdapter extends RecyclerView.Adapter<WhoRequireSevanamAdapter.ViewHolder> {
    ...
    public WhoRequireSevanamAdapter(Context context, ArrayList<SevanamTypes> sevanamTypes) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent intent = null;
                intent = new Intent(context,ViewWhoRequireSevanam.class);
                switch(position){
